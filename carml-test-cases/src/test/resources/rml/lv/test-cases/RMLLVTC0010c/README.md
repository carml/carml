...
**Title**: Expression Map in Join Condition: Template

**Description**: Test a template-valued expression map in join condition 
...
:csvView a rml:LogicalView;
  ...
  rml:leftJoin [
    ...
    rml:joinCondition [
      rml:parentMap [ rml:template "{json_first_name} {json_last_name}" ];
...
<http://example.org/person/alice%20smith> <http://example.org/hasItem> <http://example.org/person/alice%20smith/item/shield> .
<http://example.org/person/alice%20smith> <http://example.org/hasItem> <http://example.org/person/alice%20smith/item/sword> .
<http://example.org/person/bob%20jones> <http://example.org/hasBirthYear> "1999"^^<http://www.w3.org/2001/XMLSchema#gYear> .
<http://example.org/person/bob%20jones> <http://example.org/hasItem> <http://example.org/person/bob%20jones/item/flower> .
<http://example.org/person/tobias%20brown> <http://example.org/hasBirthYear> "2005"^^<http://www.w3.org/2001/XMLSchema#gYear> .
