...
class ModelsTest {
  ...
  void givenDeepModel_whenDescribeResource_thenReturnDeepDescription() {
    // Given
    Model model = Models.parse(Objects.requireNonNull(ModelsTest.class.getResourceAsStream("toDescribeDeep.ttl")),
        RDFFormat.TURTLE);
    ...
    // Then
    assertThat(described, isIsomorphicWith(Models
        .parse(Objects.requireNonNull(ModelsTest.class.getResourceAsStream("describedDeep.ttl")), RDFFormat.TURTLE)));
  }

  @Test
  void givenShallowModel_whenDescribeResource_thenReturnShallowDescription() {
    // Given
    Model model = Models.parse(Objects.requireNonNull(ModelsTest.class.getResourceAsStream("toDescribeShallow.ttl")),
        RDFFormat.TURTLE);
    IRI resource = VALUE_FACTORY.createIRI("http://example.com/Fourth");
    ...
    // Then
    assertThat(described, isIsomorphicWith(Models.parse(
        Objects.requireNonNull(ModelsTest.class.getResourceAsStream("describedShallow.ttl")), RDFFormat.TURTLE)));
  }
  ...
  void givenDeepModel_whenReverseDescribeResource_thenReturnDeepReverseDescription() {
    ...
    // Then
    assertThat(described, isIsomorphicWith(Models.parse(
        Objects.requireNonNull(ModelsTest.class.getResourceAsStream("reverseDescribedDeep.ttl")), RDFFormat.TURTLE)));
  }
  ...
  void givenShallowModel_whenReverseDescribeResource_thenReturnShallowReverseDescription() {
    ...
    assertThat(described,
        isIsomorphicWith(
            Models.parse(Objects.requireNonNull(ModelsTest.class.getResourceAsStream("reverseDescribedShallow.ttl")),
                RDFFormat.TURTLE)));
  }
  ...
  void givenDeepModel_whenSymmetricDescribeResource_thenReturnDeepSymmetricDescription() {
    ...
    // Then
    assertThat(described, isIsomorphicWith(Models.parse(
        Objects.requireNonNull(ModelsTest.class.getResourceAsStream("symmetricDescribedDeep.ttl")), RDFFormat.TURTLE)));
  }
  ...
  void givenShallowModel_whenSymmetricDescribeResource_thenReturnShallowSymmetricDescription() {
    ...
    assertThat(described,
        isIsomorphicWith(
            Models.parse(Objects.requireNonNull(ModelsTest.class.getResourceAsStream("symmetricDescribedShallow.ttl")),
                RDFFormat.TURTLE)));
  }
  ...
  void givenValues_whenAllArgsCreateStatement_thenReturnStatement() {
    ...
    Statement statement = Models.createStatement(subjectValue, predicateValue, objectValue, graphValue,
        DEFAULT_GRAPH_MODIFIER, VALUE_FACTORY, statementConsumer1, statementConsumer2);

    // Then
    Statement expected = VALUE_FACTORY.createStatement(VALUE_FACTORY.createIRI("http://example.com/subject"),
        VALUE_FACTORY.createIRI("http://example.com/predicate"), VALUE_FACTORY.createLiteral("object"),
  ...
  void givenIncorrectSubject_whenCreateStatement_thenThrowException() {
    ...
    // When
    Throwable modelsException = assertThrows(ModelsException.class,
  ...
  void givenValueSets_whenAllArgsStreamCartesianProductStatements_thenReturnStatementStream() {
    // Given
    Set<Resource> subjects = Set.of(VALUE_FACTORY.createIRI("http://example.com/subject1"),
        VALUE_FACTORY.createIRI("http://example.com/subject2"));
    Set<IRI> predicates = Set.of(VALUE_FACTORY.createIRI("http://example.com/predicate1"),
        VALUE_FACTORY.createIRI("http://example.com/predicate2"));
    Set<? extends Value> objects = Set.of(VALUE_FACTORY.createLiteral("object1"),
        VALUE_FACTORY.createLiteral("object2"), VALUE_FACTORY.createLiteral("object3"));
    Set<Resource> graphs = Set.of(VALUE_FACTORY.createIRI("http://example.com/graph1"),
        VALUE_FACTORY.createIRI("http://example.com/graph2"));

    // When
    Stream<Statement> statementStream = Models.streamCartesianProductStatements(subjects, predicates, objects, graphs,
        DEFAULT_GRAPH_MODIFIER, VALUE_FACTORY, statementConsumer1, statementConsumer2);

    // Then
    Model expected = new ModelBuilder().namedGraph(VALUE_FACTORY.createIRI("http://example.com/graph1"))
  ...
  void givenValueSetsWithoutGraphs_whenAllArgsStreamCartesianProductStatements_thenReturnStatementStream() {
    ...
    // Then
    Model expected = new ModelBuilder().subject(VALUE_FACTORY.createIRI("http://example.com/subject1"))
        .add(VALUE_FACTORY.createIRI("http://example.com/predicate1"), VALUE_FACTORY.createLiteral("object1"))
        .add(VALUE_FACTORY.createIRI("http://example.com/predicate1"), VALUE_FACTORY.createLiteral("object2"))
        .add(VALUE_FACTORY.createIRI("http://example.com/predicate1"), VALUE_FACTORY.createLiteral("object3"))
        .add(VALUE_FACTORY.createIRI("http://example.com/predicate2"), VALUE_FACTORY.createLiteral("object1"))
  ...
  void givenEmptyTripleValueSet_whenCreateStatement_thenThrowException() {
    ...
    // When
    Throwable modelsException =
        assertThrows(ModelsException.class, () -> Models.streamCartesianProductStatements(subjects, predicates, objects,
