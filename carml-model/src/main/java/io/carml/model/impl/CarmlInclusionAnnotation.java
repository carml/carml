...
import io.carml.model.InclusionAnnotation;
...
public class CarmlInclusionAnnotation extends CarmlStructuralAnnotation implements InclusionAnnotation {
    ...
    public void addTriples(ModelBuilder modelBuilder) {
        modelBuilder.subject(getAsResource()).add(RDF.TYPE, Rdf.Rml.InclusionAnnotation);
