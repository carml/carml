...
public class SaxonXPathResolver implements LogicalSourceResolver<XdmItem> {
  ...
  public static SaxonXPathResolver getInstance() {
    return getInstance(true);
  }

  public static SaxonXPathResolver getInstance(boolean autoNodeTextExtraction) {
  ...
  public static SaxonXPathResolver getInstance(Processor xpathProcessor, XPathCompiler xpathCompiler,
      boolean autoNodeTextExtraction) {
    return new SaxonXPathResolver(xpathProcessor, xpathCompiler, autoNodeTextExtraction);
  }
  ...
  private Flux<XdmItem> getXpathResultFlux(InputStream inputStream, LogicalSource logicalSource) {
    var documentBuilder = xpathProcessor.newDocumentBuilder();
