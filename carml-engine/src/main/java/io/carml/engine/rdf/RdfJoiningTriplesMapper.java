...
public class RdfJoiningTriplesMapper<R> implements TriplesMapper<Statement> {
  ...
  public static <R> RdfJoiningTriplesMapper<R> of(@NonNull TriplesMap triplesMap,
      Set<PredicateObjectMap> joiningPredicateObjectMaps, LogicalSource virtualJoiningLogicalSource,
      @NonNull LogicalSourceResolver<R> logicalSourceResolver, @NonNull RdfMapperConfig rdfMapperConfig) {
    ...
    return new RdfJoiningTriplesMapper<>(triplesMap, virtualJoiningLogicalSource, subjectMappers,
        predicateObjectMappers, logicalSourceResolver.getExpressionEvaluationFactory(),
  ...
  private static Set<RdfPredicateObjectMapper> createPredicateObjectMappers(TriplesMap triplesMap,
      Set<PredicateObjectMap> joiningPredicateObjectMaps, RdfMapperConfig rdfMapperConfig) {
