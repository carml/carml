...
class BuiltInFunctionProviderTest {
    ...
    void isNull_hasOneOptionalParameter() {
        ...
        assertThat(descriptor.getParameters().get(0).parameterIri(), is(IdlabFn.str));
    ...
    void equals_hasTwoRequiredParameters() {
        ...
        assertThat(descriptor.getParameters().get(0).parameterIri(), is(Grel.valueParam));
        assertThat(descriptor.getParameters().get(0).required(), is(true));
        assertThat(descriptor.getParameters().get(1).parameterIri(), is(Grel.valueParam2));
    ...
    void if_hasThreeParameters_firstRequiredOthersOptional() {
        ...
        assertThat(descriptor.getParameters().get(0).parameterIri(), is(Grel.bool_b));
        assertThat(descriptor.getParameters().get(0).required(), is(true));
        assertThat(descriptor.getParameters().get(1).parameterIri(), is(Grel.any_true));
        assertThat(descriptor.getParameters().get(1).required(), is(false));
        assertThat(descriptor.getParameters().get(2).parameterIri(), is(Grel.any_false));
