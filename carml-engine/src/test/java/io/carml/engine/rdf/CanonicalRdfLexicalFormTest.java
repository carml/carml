...
class CanonicalRdfLexicalFormTest {
    ...
    static Stream<Arguments> rdfLexicalFormTestArgs() {
        return Stream.of(
                Arguments.of(.224, XSD.DECIMAL, "0.224"),
                Arguments.of("+001", XSD.DECIMAL, "1.0"), // different
                // from
                ...
                Arguments.of("-5.9000", XSD.DECIMAL, "-5.9"),
                Arguments.of("05", XSD.INTEGER, "5"),
                Arguments.of(+333, XSD.INTEGER, "333"),
                Arguments.of("00", XSD.INTEGER, "0"),
                Arguments.of(-5.90, XSD.DOUBLE, "-5.9E0"),
                Arguments.of(+0.00014770215000, XSD.DOUBLE, "1.4770215E-4"),
                Arguments.of(+01E+3, XSD.DOUBLE, "1.0E3"),
                Arguments.of(100.0, XSD.DOUBLE, "1.0E2"),
                Arguments.of(0, XSD.DOUBLE, "0.0E0"),
                Arguments.of(1, XSD.BOOLEAN, "true"),
