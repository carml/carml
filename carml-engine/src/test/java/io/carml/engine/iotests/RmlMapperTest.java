...
class RmlMapperTest extends MappingTester {
    ...
    void testSubjectMapping() {
        testMapping(
                "RmlMapper", "/RmlMapper/test2/subjectMapping.rml.ttl", "/RmlMapper/test2/subjectMapping.output.ttl");
    }
    ...
    void testSettingCustomBaseIri() {
        testMapping(
                "RmlMapper",
                "/RmlMapper/baseIriTest/cars.rml.ttl",
                "/RmlMapper/baseIriTest/cars.output.ttl",
    ...
    void testMappingWithNullReference() {
        testMapping(
                "RmlMapper",
                "/RmlMapper/nullValues/nullValueReference.rml.ttl",
    ...
    void testMappingWithTemplateWithNullReference() {
        testMapping(
                "RmlMapper",
                "/RmlMapper/nullValues/nullValueTemplate.rml.ttl",
    ...
    void testMappingWithTemplateWithMultiValuedNullReference() {
        testMapping(
                "RmlMapper",
                "/RmlMapper/nullValues/nullValueMultiValuedTemplate.rml.ttl",
    ...
    void testMappingWithLanguageMap() {
        testMapping(
                "RmlMapper",
                "/RmlMapper/languageMap/languageMap.rml.ttl",
