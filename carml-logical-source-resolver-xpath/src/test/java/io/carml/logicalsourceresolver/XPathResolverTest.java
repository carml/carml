...
class XPathResolverTest {
    ...
    void givenXml_whenRecordResolverAppliedTwice_thenReturnFluxOfAllRecords() {
        ...
        var resolvedSource2 = ResolvedSource.of(inputStream2, new TypeRef<>() {});
        ...
        // Then
        StepVerifier.create(recordFlux2).expectNextCount(4).verifyComplete();
    }
    ...
    void givenXmlAndLSourceWithNestedAndRootExpression_whenRecordResolverApplied_thenReturnFluxOfAllRecords() {
        ...
        // Then
        StepVerifier.create(recordFlux).expectNextCount(3).verifyComplete();
    }
    ...
    void givenNoLogicalSources_whenRecordResolverApplied_thenThrowException() {
        ...
        var illegalStateException =
                assertThrows(IllegalStateException.class, () -> recordResolver.apply(resolvedSource));
    ...
    void givenExpression_whenExpressionEvaluationWithoutAutoTextExtractionApplied_thenReturnCorrectValue() {
        ...
        resolvedSource = ResolvedSource.of(inputStream, new TypeRef<>() {});
