 ...
 *
 * <p>DuckDB result rows do not carry per-field reference formulations or natural datatypes, so
 * {@link #getFieldReferenceFormulation(String)} and {@link #getNaturalDatatype(String)} always
 * return empty.
 */
class DuckDbViewIteration implements ViewIteration {
     ...
     *     JOINs)
     */
    DuckDbViewIteration(int index, Map<String, Object> values) {
        this.index = index;
